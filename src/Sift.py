...
def generateFeatures(img, sigma = 1.6, num_intervals = 3, assumed_blur = 0.5, image_border_width = 5):
        #.......Parameters of the main function of sift.......................
        #  img: original Image
        #  sigma: Standard Deviation Parameter Passed to Gaussian Blurring Function
        #  num_intervals: Number of scales Per Octave 
        #  assumed_blur: Blurring Ratio
        #  image_border_width: Padding Added to the Image Borders
        #........return of the function........................................
        # Array of KeyPoint Objects and an Array of Descriptors for each KeyPoint
        #each keyPoint have 128 feature   
        original_image= copy(img)
        grey_scaled = cvtColor(original_image, COLOR_BGR2GRAY)
        grey_scaled = grey_scaled.astype('float32')
        base_image = generateBaseImage(grey_scaled, sigma, assumed_blur)
    ...
    ########################### Image pyramids ###########################
def generateBaseImage(original_image, sigma, assumed_blur):
        #Generate base image from input image by up sampling by 2 in both directions and blurring

        image = resize(original_image, (0, 0), fx=2, fy=2, interpolation=INTER_LINEAR)
...
def generateGaussianImages(original_image, num_octaves, gaussian_kernels):
        #Generate scale-space pyramid of Gaussian images
        gaussian_images = []

        for octave_index in range(num_octaves):
            gaussian_images_in_octave = [original_image]
            for gaussian_kernel in gaussian_kernels[1:]:
                original_image = GaussianBlur(original_image, (0, 0), sigmaX=gaussian_kernel, sigmaY=gaussian_kernel)
                gaussian_images_in_octave.append(original_image)
            gaussian_images.append(gaussian_images_in_octave)
            octave_base = gaussian_images_in_octave[-3]
            original_image = resize(octave_base, (int(octave_base.shape[1] / 2), int(octave_base.shape[0] / 2)),
                    ...
                    for j in range(image_border_width, first_image.shape[1] - image_border_width):
                        ...
                        if isPixelAnExtremum(first_image[i - 1:i + 2, j - 1:j + 2], second_image[i - 1:i + 2, j - 1:j + 2],
                            ...
                            localization_result = localizeExtremumViaQuadraticFit(i, j, image_index + 1, octave_index,
                                                                                num_intervals, images_in_octave,
...
def localizeExtremumViaQuadraticFit(i, j, image_index, octave_index, num_intervals, images_in_octave,
        ...
        image_shape = images_in_octave[0].shape
        ...
        for attempt_index in range(num_attempts_until_convergence):
            ...
            first_image, second_image, third_image = images_in_octave[image_index - 1:image_index + 2]
...
def compareKeypoints(keypoint1, keypoint2):
        #if keypoint1 is less than keypoint2 return true
...
def removeDuplicateKeypoints(keypoints):
        #Sort the keypoints and remove duplicated ones 
        if len(keypoints) < 2:
            return keypoints
...
def generateDescriptors(keypoints, gaussian_images, window_width=4, num_bins=8, scale_multiplier=3,
        ...
        for keypoint in keypoints:
            ...
            # Thresholding and normalize the descriptor_vector
